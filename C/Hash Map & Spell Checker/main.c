...
**Date: 03/03/16
**Description: counts the occurance of words
** within the provided .txt file and displays them.
*/
...
int main (int argc, const char * argv[]) {
	...
	while (word != 0)
	{
		...
		{
			ValueType *numValue = atMap(hashTable, word);
			/*obtains the word count in numValue*/

			insertMap(hashTable, word, *numValue + 1);
			/*increments the count at that word*/
