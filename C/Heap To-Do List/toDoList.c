...
**Date: 02/25/16
**Description: contains functions for creating tasks
**  and comparing elements in the heap.
*/
...
{
	struct Task *leftNode = (struct Task *)left;
	struct Task *rightNode = (struct Task *)right;
...
TaskP createTask (int priority, char *desc)
{
	...
	/*method copies characters into description in string form*/
